...
class Student extends Model
{
  ...
  public function retrieve()
  {
    return DB::table('students as a')
      ->select(
        DB::raw("a.admission_no,a.roll_no,a.full_name,a.gender_name,a.email,a.mobile,a.disability,a.father_name,a.month_id,
        e.category_name,
        c.class_name,
        d.section,
        b.financial_year,
  ...
  {
    // vode version - 2: changing due to month added for manage mid session 
    return DB::table('students as a')
      ->select(
        DB::raw("a.admission_no,a.roll_no,a.full_name,a.gender_name,a.email,a.mobile,a.disability,a.father_name,a.id,a.month_id,
        e.category_name,
        c.class_name,
        d.section,
        f.month_name,
        ...
        WHEN a.disability = '1' THEN 'Yes'
        END as disability,
        CASE WHEN a.is_parent_staff = '0' THEN 'No'  
        WHEN a.is_parent_staff = '1' THEN 'Yes'
        END as is_parent_staff,
        CASE WHEN a.status = '0' THEN 'Deactivated'  
        WHEN a.status = '1' THEN 'Active'
        END as status,
        CASE WHEN a.is_mid_session = '1' THEN 'Yes'  
        WHEN a.is_mid_session = '0' THEN 'No' 
  ...
  {
    //code version 2: changing due to month id added for manange mid session
    return DB::table('students as a')
      ->select(
        DB::raw("a.admission_no,a.roll_no,a.full_name,a.gender_name,a.email,a.mobile,a.disability,a.father_name,a.id,a.month_id,
        e.category_name,
    ...
    //code version 1: getting student records
    // return DB::table('students as a')
    //   ->select(
    //     DB::raw("a.admission_no,a.roll_no,a.full_name,a.gender_name,a.email,a.mobile,a.disability,a.father_name,a.id,
    //     e.category_name,
