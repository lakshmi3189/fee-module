...
class FeeCollection extends Model
{
  ...
  public function readAllFeeCollectionGroup($ob, $studentId, $studentFY)
  {
  ...
  public function readFeeCollectionGroup($req, $stdId, $fy)
  {
    $schoolId = authUser()->school_id;
    // $createdBy = authUser()->id;
  ...
  public function getGroupByReceipt($req)
  {
    ...
    return DB::table('fee_collections as a')
      ->select(
        DB::raw("a.month_name, a.total_fee,                
      ...
      ->join('section_group_maps as d', 'd.id', '=', 'b.section_id')
  ...
  public function getGroupByReceiptTest($req)
  {
    ...
    $selectData = $from->select(
      DB::raw("fee_collections.month_name,fee_collections.total_fee,fee_heads.fee_head,
